...
export function SignUpPage() {
  ...
  // Check if ID.ME verification was completed
  const isVerified = localStorage.getItem("onboardai_idme_verified") === "true";

  if (!isVerified) {
    // Redirect to ID.ME verification if not verified
    navigateTo("idme-verification");
    return null;
  }
  ...
  const handleEmailSignUp = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (accountType === "talent") {
        ...
        navigateTo("recruiter-profile-setup");
      }
    }, 1500);
  };
  ...
  const handleOAuthSignUp = (provider: "google" | "linkedin") => {
    ...
    // For now, show account type selection if not already selected
    if (!accountType) {
      setIsLoading(false);
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <h2 className="heading-display text-white text-3xl md:text-4xl mb-2">
            Create Your <span className="text-gradient-multi">Account</span>
          </h2>
          <p className="text-violet-100">
            Join Onboard.AI and start building your professional future
          </p>
        </div>
        ...
        <Card>
          <CardHeader className="text-center pb-4">
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <span className="text-sm text-green-600 font-medium">ID.ME Verified</span>
            </div>
            <CardTitle>Sign Up</CardTitle>
            <CardDescription>
              Choose your sign-up method and account type
            </CardDescription>
          </CardHeader>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-xs opacity-80">Build my GPR</span>
                  </div>
                </Button>
                <Button
                  type="button"
